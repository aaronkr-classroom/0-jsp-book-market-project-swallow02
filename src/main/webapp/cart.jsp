...
<div class="row align-items-md-stretch">
  ...
  <td calign="right"><a href="./shippingInfo.jsp?cartId=<%=cartId %>"
 ...
 <tr>
  ...
  <td><%=total %></td>
  <td><a href=",/removeCart.jsp?id=<%=book.getBookId() %>" class=
  "badge text-bg-danger">삭제</a></td>
  </tr>
  <%
        }
  %>
  ...
  <a href="./books.jsp" class="btn btn-secondary">&laquo; 쇼핑 계속하기
  </a>
</div>
