...
public BookRepository() {
	...
	book1.setAuthor("우재남");
	book1.setDescription("C#을 처음 접하는 독자를 대상으로 일대일 수업처럼 자세히 설명한 책이다. 꼭알아야 할 핵심 개념은 기본 예제로 최대한 쉽게 설명했으며, 중요한 내용은 응용 예제,퀴즈,셀프 스터디,예제 모음으로 한번 더 복습할 수 있다");
	...
	Book book2 = new Book("ISBN1234","자바마스터",30000);
	book2.setAuthor("송미영");
	...
	Book book3 = new Book("ISBN1234","파이썬 프로그래밍",30000);
	book3.setAuthor("최성철");
